...
print("Take photos with different exposure settings")
...
def main():
    ...
    #cam.exposure_value = -3..+3
    #cam.brightness = -4..+4
    #cam.saturation = -4..+4
    #cam.constrast = -3..+3

    # Let's take shots varying to exposure value
    # the brightness 
    # and the contrast.
    ...
    while True:
        ...
        if not button.value:
            ...
            for e in range(-3,0):
                for c in range(-3,4):
                    for b in range(-4,5):
                        print("Taking picture {}/{}/{}".format(e,c,b))
                        cam.exposure_value = e
                        cam.contrast = c
                        cam.brightness = b
                        cam.capture(buffer)
                        jpgPath = dirPath + "/capture_{}_{}_{}.jpg".format(e,c,b)
