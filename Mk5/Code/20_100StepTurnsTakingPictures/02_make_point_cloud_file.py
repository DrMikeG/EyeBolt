...
s_video_output_file = "./Mk5/Code/20_100StepTurnsTakingPictures/run_0{}_x_run_0{}.mp4".format(run,run+1)  # Name of the output video file
pc_output_file = "./Mk5/Code/20_100StepTurnsTakingPictures/run_0{}_output.xyz".format(run)
...
if makeSideBySideVideo:
    light_images = glob.glob('./Mk5/Code/20_100StepTurnsTakingPictures/run_0{}/*.jpg'.format(run+1))
