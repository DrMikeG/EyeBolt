...
print("Run a 360 capture using bespoke camera settings")
...
def main():
    ...
    while True:
        ...
        if not button.value:
            ...
            for r in range(10):
                print("Taking picture {} start".format(r))
                jpgPath = dirPath + "/capture_{:0>3}_{}x{}_{}_aStart.jpg".format(r,width,height,quality)
                cam.capture(buffer)
                ...
                for n in range(124): # 124 seems to be more exactly 360 degrees                    
